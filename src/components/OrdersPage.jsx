...
  };
  return (
    <div className="container mx-auto p-8 bg-gradient-to-r from-green-100 to-green-100 min-h-screen">
      <h2 className="text-4xl font-bold text-center text-green-800 mb-4">Mis Pedidos</h2>
      {orders.length === 0 ? (
